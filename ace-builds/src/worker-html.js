...
TreeBuilder.prototype.ensure***REMOVED***sArkCondition = function(item) {
	var k***REMOVED***sArkCapacity = 3;
	if (this.activeFormattingElements.length < k***REMOVED***sArkCapacity)
		return;
	var candidates = [];
	...
	if (candidates.length < k***REMOVED***sArkCapacity)
		return;
	...
	for (var i = 0; i < attributes.length; i++) {
		...
		if (remainingCandidates.length < k***REMOVED***sArkCapacity)
			return;
		candidates = remainingCandidates;
		remainingCandidates = [];
	}
	for (var i = k***REMOVED***sArkCapacity - 1; i < candidates.length; i++)
...
TreeBuilder.prototype.appendElementToActiveFormattingElements = function(item) {
	this.ensure***REMOVED***sArkCondition(item);
